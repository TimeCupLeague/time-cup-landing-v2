  ...
  var a = 'undefined' != typeof window ? window : this,
    e = (a.Glider = function (e, t) {
      ...
      ;(i.track.classList.add('glider-track'),
        ...
        i.event(i.ele, 'add', { scroll: i.updateControls.bind(i) }, { passive: i.opt.passiveListeners }),
  ...
  return (
    (t.init = function (e, t) {
      ...
      ;((t = t || l),
        ('auto' !== o.opt.slidesToShow && void 0 === o.opt._autoSlide) ||
          ...
          (o.opt._autoSlide = o.opt.slidesToShow = o.opt.exactWidth ? i : Math.max(1, Math.floor(i)))),
    ...
    (t.bindDrag = function () {
      ...
      ;(t.ele.classList.toggle('draggable', !0 === t.opt.draggable),
        ...
        t.opt.draggable && t.event(t.ele, 'add', o, { passive: t.opt.passiveListeners }))
    }),
    ...
    (t.updateControls = function (e) {
      var n = this,
        ...
        a =
          (n.opt.rewind ||
            (n.arrows.prev &&
              (n.arrows.prev.classList.toggle('disabled', n.ele.scrollLeft <= 0 || t),
              n.arrows.prev.setAttribute('aria-disabled', n.arrows.prev.classList.contains('disabled'))),
            n.arrows.next &&
              (n.arrows.next.classList.toggle(
                'disabled',
                Math.ceil(n.ele.scrollLeft + n.containerWidth) >= Math.floor(n.trackWidth) || t,
              ),
          ...
          var i = e.classList,
            ...
            r =
              ...
              a === t || (d && d === t)
                ? i.add('center')
                : (i.remove('center'),
                  i.add([t < a ? 'left' : 'right', Math.abs(t - ((!(t < a) && d) || a))].join('-'))),
              Math.ceil(r) >= Math.floor(o) && Math.floor(l) <= Math.ceil(s))
          ;(i.toggle('visible', r), r !== e && n.emit('slide-' + (r ? 'visible' : 'hidden'), { slide: t }))
        }),
        n.dots &&
          ...
          (n.scrollLock = setTimeout(function () {
            ;(clearTimeout(n.scrollLock),
              0.02 < Math.abs(n.ele.scrollLeft / n.itemWidth - n.slide) &&
                (n.mouseDown ||
                  (n.trackWidth > n.containerWidth + n.ele.scrollLeft && n.scrollItem(n.getCurrentSlide()))))
      ...
      var o,
        ...
        l =
          !0 === t
            ...
            : ('string' == typeof e &&
                ((l = 'prev' === e),
                (e = s.opt.slidesToScroll % 1 || s.opt.slidesToShow % 1 ? s.getCurrentSlide() : s.slide),
        ...
        for (var i = 0; i < t.length; ++i) {
          ...
          if (a.innerWidth >= o.breakpoint)
            return (
              ...
              ((e.opt = Object.assign({}, e._opt, o.settings)), (e.breakpoint = o.breakpoint), !0)
            )
        }
      }
    ...
    (t.scrollTo = function (t, i, o) {
      var s = this,
        ...
        n = function () {
          ...
          ;((s.ele.scrollLeft = s.ele.scrollLeft + (t - s.ele.scrollLeft) * s.opt.easing(0, e, 0, 1, i)),
            e < i && l === s.animate_id
